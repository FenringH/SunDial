...
public class Sunconfig {
    ...
    public static final double SUNRISE_DIAL_SHORT_LENGTH = CENTER_Y - DOT_RADIUS_BIGH + 20;
    ...
    public static final double MATRIX_TIMEDATE_OFFSET = 125.0d;
